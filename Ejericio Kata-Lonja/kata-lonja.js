...
function calcularCiudad(cantidadAlimento1, precio1, cantidadAlimento2, precio2, cantidadAlimento3, precio3) {
    return (precio1 * cantidadAlimento1) + (precio2 * cantidadAlimento2) + (cantidadAlimento3 * precio3);
}
function calcularCiudadConDesprecioCarga(precioPorCiudad, distanciaCiudad) {
    var desprecioPorTransporte = (1 - 0.01 * distanciaCiudad / 100);
    var precioCargarFurgoneta = 5 + 2 * distanciaCiudad;
    return precioPorCiudad * desprecioPorTransporte - precioCargarFurgoneta;
}
var Madrid;
var Barcelona;
var Lisboa;
for (var i = 0; i < ciudades.nombres.length; i++) {
    var precioPorCiudadX = void 0;
    var datos;
